...
import (
	...
	"github.com/cage1016/gokitsonsulk8s/pkg/producersvc/transports"
)

const (
	defZipkinV2URL string = ""
	defNameSpace   string = "gokitconsulk8s"
	defServiceName string = "producersvc"
...
func NewServer(cfg config, logger log.Logger) (pb.ProducersvcServer, http.Handler) {
...
func startGRPCServer(cfg config, hs *health.Server, grpcServer pb.ProducersvcServer, logger log.Logger, errs chan error) {
	...
	pb.RegisterProducersvcServer(server, grpcServer)
