...
// Endpoints collects all of the endpoints that compose the producersvc service. It's
...
func New(svc service.ProducersvcService, logger log.Logger, otTracer stdopentracing.Tracer, zipkinTracer *stdzipkin.Tracer) (ep Endpoints) {
...
func MakeSumEndpoint(svc service.ProducersvcService) (ep endpoint.Endpoint) {
...
// Primarily useful in a server.
func MakeConcatEndpoint(svc service.ProducersvcService) (ep endpoint.Endpoint) {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
