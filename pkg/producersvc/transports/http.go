...
func NewHTTPClient(instance string, otTracer stdopentracing.Tracer, zipkinTracer *stdzipkin.Tracer, logger log.Logger) (service.ProducersvcService, error) { // Quickly sanitize the instance string.
